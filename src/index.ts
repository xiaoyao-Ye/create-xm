...
const FRAMEWORKS: Framework[] = [
  {
    ...
    variants: [
      ...
      },
      {
        ...
        display: "vitesse ↗",
        color: lightGreen,
        customCommand: "npx degit https://github.com/antfu/vitesse#main TARGET_DIR",
      },
    ],
  },
  {
    ...
    variants: [
      ...
      {
        name: "react-admin",
        display: "React-Admin(React18、React-Router V6、React-Hooks、Redux、TypeScript、Vite2、Ant-Design)",
        color: yellow,
    ...
    variants: [
      {
        ...
        display: "uniapp ↗",
        color: yellow,
        customCommand: "npx degit https://github.com/xiaoyao-Ye/template/uniapp#main TARGET_DIR",
      },
      {
        name: "npm",
        display: "npm ↗",
      ...
      },
      {
        ...
        color: reset,
        customCommand: "npx degit https://github.com/xiaoyao-Ye/frontend-basic#main TARGET_DIR",
      },
      {
        name: "nest",
        display: "nest-admin ↗",
        color: cyan,
        customCommand: "npx degit https://github.com/buqiyuan/nest-admin#main TARGET_DIR",
      },
    ],
  },
];
...
async function init() {
  ...
  if (overwrite) {
    ...
    // 当前模板列表都是使用 degit 创建项目，如果目录不存在，会自动创建, 这里不需要再创建
  ...
  if (customCommand) {
    ...
    // 如果是使用的cli工具创建项目，这里不需要再执行后续的操作
    // 但是 create-xm 准备的模板都是使用 degit 创建项目，所以这里需要执行后续的操作
